            ...
            <div key={s.id} className="flex items-center gap-2 py-1.5 border-b border-border last:border-0">
              <span
                className={`w-2 h-2 rounded-full shrink-0 ${
                  s.status === 'pass' ? 'bg-teal-600' : s.status === 'warn' ? 'bg-sky-500' : 'bg-red-600'
                }`}
              />
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 md:py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="rounded-xl border border-border bg-bg-surface p-5 md:p-6">
            <div className="mb-4 pb-3 border-b border-border">
              <span className="text-[10px] font-mono font-semibold uppercase tracking-wider text-sky-500">Site B</span>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6">
      <div className="p-6 md:p-8 rounded-xl border border-border bg-bg-surface">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border border-border bg-bg-base text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-sky-500 transition-shadow"
              />
            </div>
            <div>
          ...
          <button
            type="submit"
            className="px-6 py-3 rounded-lg text-white font-medium text-sm transition-all hover:-translate-y-0.5 hover:brightness-105"
