      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-lg border border-border bg-bg-surface text-text-primary text-sm placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-sky-500 transition-colors disabled:opacity-60"
          />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <select
              ...
              disabled={isLoading}
              className="w-full px-3 py-2 rounded-lg border border-border bg-bg-surface text-text-primary text-sm focus:outline-none focus:ring-2 focus:ring-sky-500 transition-colors disabled:opacity-60"
            >
        ...
        <div>
          ...
          <textarea
            ...
            disabled={isLoading}
            className="w-full px-3 py-2 rounded-lg border border-border bg-bg-surface text-text-primary text-sm placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-sky-500 transition-colors resize-y disabled:opacity-60"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full sm:w-auto px-6 py-2.5 rounded-lg text-white font-semibold text-sm transition-all hover:-translate-y-0.5 hover:brightness-105 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:brightness-100 inline-flex items-center justify-center gap-2"
          style={{ background: 'linear-gradient(135deg, #0D9488 0%, #06B6D4 52%, #38BDF8 100%)', boxShadow: '0 6px 18px -6px rgba(13, 148, 136, 0.45)' }}
        >
          {isLoading ? (
            <>
        ...
        <section className="space-y-5" aria-label="Generated llms.txt">
          ...
          <div>
            ...
            <textarea
              ...
              rows={16}
              spellCheck={false}
              className="w-full px-3 py-3 rounded-lg border border-border bg-bg-surface text-text-primary text-xs font-mono leading-relaxed focus:outline-none focus:ring-2 focus:ring-sky-500 transition-colors resize-y"
            />
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <button
              type="button"
              onClick={handleCopy}
              className="px-4 py-2 rounded-lg text-white font-medium text-sm transition-all hover:-translate-y-0.5 hover:brightness-105 inline-flex items-center gap-2"
              style={{ background: 'linear-gradient(135deg, #0D9488 0%, #06B6D4 52%, #38BDF8 100%)' }}
            >
              {copied ? 'Copied!' : 'Copy'}
            </button>
            <button
