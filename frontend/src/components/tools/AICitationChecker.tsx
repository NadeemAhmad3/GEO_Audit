...
> = {
  ...
  cited: {
    ...
    tone: 'border-cyan-500/40 bg-cyan-500/5',
  },
  mentioned_only: {
    icon: '🟡',
    ...
    <div>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid sm:grid-cols-2 gap-4">
          <label className="block">
            ...
            <input
              ...
              placeholder="Acme"
              className="mt-1 w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-sky-500 transition-shadow"
            />
          </label>
          <label className="block">
        ...
        <button
          ...
          className="w-full sm:w-auto rounded-lg px-6 py-2.5 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:brightness-105 disabled:opacity-50 disabled:hover:translate-y-0 disabled:hover:brightness-100"
